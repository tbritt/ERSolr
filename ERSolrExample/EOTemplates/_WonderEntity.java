...
#if ($attribute.userInfo.indexed)
  public static final boolean ${attribute.uppercaseUnderscoreName}_INDEXED = $attribute.userInfo.indexed;
#end
#if ($attribute.userInfo.stored)
  public static final boolean ${attribute.uppercaseUnderscoreName}_STORED = $attribute.userInfo.stored;
#end
#if ($attribute.userInfo.multiValued)
  public static final boolean ${attribute.uppercaseUnderscoreName}_MULTIVALUED = $attribute.userInfo.multiValued;
#end
#end
